...
$(function () {
  ...
  if (location.search.length) {
    ...
    setupRoleSelect(false); //Select the variant if it has one
...
function buildSelectedSidekick() {
  ...
  sidekickStats = scaleMonster(monsterID, '0.5', options); //Apply any customizations to the derived statblock
