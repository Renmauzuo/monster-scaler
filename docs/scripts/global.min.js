...
function calculateSelectedMonster() {
  ...
  if (!derivedStats.bonusArmor) {
     ...
     */
    let acBenchmarks = findBenchmarksForStat(["bonusArmor", "dex"], targetCR, selectedMonster); //Creature may not have bonus armor at all, in which case we skip this step
  ...
  derivedStats.swim = findNearestLowerBenchmark('swim', targetCR, selectedMonster); //Once we have all the stats populate the statblock:
