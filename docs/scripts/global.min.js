...
function calculateSelectedMonster() {
  ...
  derivedStats.traits = selectedMonster.traits; //Once we have our locked stats, go through the rest of the states to interpolate or extrapolate based on existing values.
