...
const pronouns = [{}, //First one is blank since 0 is default for creature type
{
  subject: 'he',
  object: 'him',
  possessive: 'his',
...
const magicSchools = [schoolAbjuration, schoolConjuration, schoolDivination, schoolEnchantment, schoolEvocation, schoolIllusion, schoolNecromancy, schoolTransmutation];
const spells = {
  barkskin: {
    name: 'barkskin'
  },
  ...
  expert: {
    ...
    features: [{
      ...
      options: [{
        ...
        limit: 2,
        list: statblock => {
          let skillList = {}; //Get a list of skills the expert is proficient in
        ...
        list: statblock => {
          ...
          for (let spell in spells) {
            if (spells[spell].level === 0) {
              cantrips[spell] = {
                name: toTitleCase(spells[spell].name)
              };
            }
          }
